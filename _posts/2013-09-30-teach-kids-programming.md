...
This is a website where kids can play little games (available in 40 languages) and then click the 'See inside' button to see the code behind the game in a kid friendly way. It’s a great way to get kids to see code and learn not just programming, but the concepts of open source.</li>
